package com.circle.common.utils;
...
public class UmengEventUtils {
    ...
    private static HashMap<String, String> getInstallMap(Context ctx) {
        HashMap<String, String> map = new HashMap<String, String>();
        map.put(PHONEMODEL, UmengCommonUtils.getPhoneModel());
        map.put(DEVICEID, UmengCommonUtils.getDeviceId(ctx));
        map.put(IMSI, UmengCommonUtils.getIMSI(ctx));
        map.put(MAC, UmengCommonUtils.getLocalMacAddressFromWifiInfo(ctx));
        return map;
    }
}